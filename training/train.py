...
# === Configuration ===
DEVICE = 0  # GPU
DATASET_DIR = "data_yolo" # path to dataset
DATA_YAML = os.path.join(DATASET_DIR, "data.yaml")
WEIGHTS_PATH = "/yolov8s.pt" #path to the model checkpoints pretrained on COCO dataset
PROJECT_NAME = "runs_yolov8"
PLOTS_DIR = "analysis_plots_yolov8" # or yolov9
...
best_model_path = os.path.join(PROJECT_NAME, "best_model_8.pt")
