...
BEST_MODEL_PATH = os.path.join("/mnt/storage/admindi/home/nfarhat/object_detection/runs_yolov8_synth_12/best_model_8_synth.pt")
PLOTS_DIR = "runs_yolov8_synth"

os.makedirs(PLOTS_DIR, exist_ok=True)

# === Load best run name
with open("/mnt/storage/admindi/home/nfarhat/object_detection/yolov8_finetune/best_run_8.txt") as f:
    best_run_name = f.read().strip()

print(f" Evaluating best model from run: {best_run_name}")
